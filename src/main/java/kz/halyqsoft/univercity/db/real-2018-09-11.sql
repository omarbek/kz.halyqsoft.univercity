...
ALTER TABLE user_address
  ALTER COLUMN postal_code TYPE CHARACTER VARYING(7);

UPDATE accountant_price
SET price_in_letters_kaz='Жүз жетпіс мың'
WHERE id=1;

UPDATE accountant_price
SET price_in_letters_kaz='Алпыс үш мың'
WHERE id=2;


UPDATE accountant_price
SET price_in_letters_kaz='Жүз қырық мың'
WHERE id=3;

UPDATE accountant_price
SET price_in_letters_kaz='Екі жүз жиырма мың'
WHERE id=4;


UPDATE accountant_price
SET price_in_letters_kaz='Сегіз жүз мың'
WHERE id=5;

UPDATE accountant_price
SET price_in_letters_kaz='Жүз отыз мың'
WHERE id=6;

UPDATE accountant_price
SET price_in_letters_kaz='Бес мың'
WHERE id=7;


UPDATE accountant_price
SET price_in_letters_kaz='Жүз жиырма мың'
WHERE id=8;
