...
--damira
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('Ақылы білім беру қызметін көрсету туралы', 0, 0, 'Normal', 12, 90, 66.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('Шымкент қ.       ', 9, 9, 'Normal', 12, 90, 67.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('$DataMonthYear', 399, -18, 'Normal', 12, 90, 68.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('Оңтүстік Қазақстан педагогикалық университеті мекемесі, лицензия № KZ80LAA00006618, 02.03.2016 ж. университет президенті Юнусов Мадияр Бактиярұлы университет жарғысы негізінде бір жағынан «БІЛІМ БЕРУ ҰЙЫМЫ» ретінде және «БІЛІМ АЛУШЫ»', 9, 0, 'Normal', 12, 90, 69.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('$fio,', 0, 0, 'Normal', 12, 90, 69.10, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('Екінші жағынан, төмендегідей келісім-шарт жасады:', 9, 3, 'Normal', 12, 90, 71.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('1. Келісім-шарт
', 0, 3, 'Bold', 12, 90, 72.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('1.1 БІЛІМ БЕРУ ҰЙЫМЫ БІЛІМ АЛУШЫҒА $speciality мамандығы бойынша $formaobuch оқу формасы негізінде мемлекеттік жалпыға міндетті білім тиісті, біліктілікке диплом  жұмысын (жобасы) қорғау аяқталған соң, мемлекеттік үлгідегі жоғары кәсіби білім туралы  диплом беруге міндеттеледі.
1.2 БІЛІМ АЛУШЫ осы келісім-шарттарына сәйкес төлемақысын  төлеуді іске асыруға міндеттеледі.', 9, 3, 'Normal', 12, 90, 73.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('2. Тараптардың міндеттері мен құқықтары
', 0, 3, 'Bold', 12, 90, 74.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('2.1 БІЛІМ БЕРУ ҰЙЫМЫ міндеттеледі:
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('4) Тиісті нормативтерге сәйкес үзілістерімен   түзілген оқу жоспары бойынша білім алушының игеруі тиісті білім көлемін қамтамасыз етуге және оған қауіпсіз жағдай туғызуға;
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('7) Өз еркімен ғылыми, мәдени және спорттық іс-шараларға, сондай-ақ халықаралық деңгейде өткізілетін іс-шараларға қатысуына мүмкіндік беруге;
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('2.2. БІЛІМ БЕРУ ҰЙЫМЫ құқығы:', 9, 0, 'Bold', 12, 90, 78.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('1) БІЛІМ АЛУШЫДАН осы келісім-шартқа сәйкес өзіне алған міндеттерін адал және мұқият орындауын, сондай-ақ университет оқытушыларын, қызметкерлерін және студенттерін сыйлауды, оқу тәртібін сақтауды талап етуге;
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('2.3 БІЛІМ АЛУШЫ міндеттенеді:
', 9, 0, 'Bold', 12, 90, 81.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('1) Мемлекеттік жалпыға білім беру стандартының толық көлемінде білім мен  практикалық дағдыларды игеруді, сабақтардың барлық оқу түрлеріне қатысуға және іс-тәжірибенің барлық түрінен өтуге;
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('6) Себепті жағдайлармен міндетті сабақтарға қатыса алмаған жағдайда ресми айғақты құжаттар тапсыруға;
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3) Кітапхана мен оқу залында оқу, оқу-әдістемелік және ғылыми әдебиеттер қорын еркін пайдалануға;
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3. Төлем ақының көлемі мен оны төлеу тәртібі
', 0, 0, 'Bold', 12, 90, 192.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3.1 Осы келісім-шартқа сәйкес төлемақы көлемі  $money                        $InLetters .', 9, 0, 'Normal', 12, 90, 193.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('  (санмен)	                          (жазумен)
', 270, 0, 'Normal', 12, 90, 194.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('25 қыркүйекке дейін – $ansEdu теңге       25 қаңтарға дейін – $ansEdu теңге
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('Білім алғаны үшін төлемақы жыл басында немесе оқу жылы кезінде тәртібін анықтайтын ҚР үкіметінің Қаулысына сәйкес, ҚР Білім және ғылым министрлігінің бұйрықтарына сәйкес, ҚР үкіметінің Қаулысына сәйкес университет қызметкерлерінің жалақысы көбейген жағдайда, белгіленген тәртіпте коммуналдық қызмет тарифтерінің өсуіне және БІЛІМ БЕРУ ҰЙЫМЫНЫҢ еркінен тыс болған жағдайларға байланысты өсуі мүмкін.', 9, 0, 'Normal', 12, 90, 196.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3.2 БІЛІМ АЛУШЫ бүкіл оқу мерзімінің төлемақысын осы келісім-шарт түзілген сәтте, осы жылдың 1 қазанына дейін толық төлесе, БІЛІМ АЛУШЫҒА жылдық оқу төлемақысынан 10% жеңілдік жасалады.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3.4 Оқу төлемақысын бөліп төлеген жағдайда, екі жақтың келісімі негізінде еңбек ақысының жоғарылауы мен инфляцияға байланысты төлемақының көлемі жылына 1-реттен артық өзгермеуі керек. Төлемақы көлемі өзгерген жағдайда бұл туралы осы келісім-шартқа қосымша енгізіледі. Бірақ төлемақыға жасалған өсім еңбек ақысының жоғарылауы мен жалпы төлемақыға қатысты алғандағы инфляция индексінен артпауы керек.
', 9, 0, 'Normal', 12, 90, 198.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3.5 Егер БІЛІМ АЛУШЫНЫҢ ықыласымен осы келісім-шарт бұзылатын болса, БІЛІМ БЕРУ ҰЙЫМЫ бұйрық шыққанға дейінгі мерзімге тиесілі ақшаны ұстап қалып, қалғанын қайтаруға міндетті.
3.6 Төлемақы тиісті сомманы ЖОО есеп айырысу шотына аудару арқылы жүргізіледі.

', 9, 0, 'Normal', 12, 90, 199.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('3.7 БІЛІМ АЛУШЫ академиялық демалысқа немесе оқудан шыққан жағдайда, келісім-шарт бұзылып, оқу төлемақысы демалыс аяқталған сәтте белгіленген мөлшерде жүргізіледі.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('4. Тараптардың жауапкершілігі
', 0, 0, 'Bold', 12, 90, 201.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('4.1 Оқу үшін төлемақы төленбеген жағдайда немесе семестр бойы себепсіз 60 сағат дәрістерге қатыспағаны үшін БІЛІМ АЛУШЫ ректордың бұйрығымен ЖОО-нан шығарылады. БІЛІМ АЛУШЫ 	4 аптаның ішінде қарызын өтеген жағдайда 40000 (қырық) мың теңге мөлшерінде айыппұл төлеп, оқуға қайта қабылданады.', 9, 0, 'Normal', 12, 90, 202.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('4.2 Егер БІЛІМ АЛУШЫ оқу ақысын төлемегені үшін оқудан шығарылса, қарызын қайтармайынша, академиялық анықтама және өзге құжаттар берілмейді. Оқуды бітірер кезде қарызы болса, оны қайтармайынша, ЖОО-ны бітіргені туралы құжат берілмейді.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('1) БІЛІМ АЛУШЫ университеттің жарғысында көрсетілген ішкі тәртіп пен талапты бұзған жағдайда оқу үшін төленген ақы қайтарылмайды.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('4.5 Лицензияның жойылуы немесе қайтарып алуына байланысты БІЛІМ БЕРУ ҰЙЫМЫНЫҢ – қызметі тоқталған жағдайында, БІЛІМ БЕРУ ҰЙЫМЫ осы келісім-шартта көрсетілген оқу төлемақысы шарттарын сақтай отырып, басқа білім беру ұйымдарында оқу жылын аяқтауға міндетті.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('5. Келісім – шарт мерзімі
', 0, 0, 'Bold', 12, 90, 206.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('5.1 Осы келісім-шарт тараптардың қол қойған сәтінен бастап өз күшіне енеді, БІЛІМ АЛУШЫНЫҢ білім алу уақыты аяқталғанға дейін және оған мемлекеттік үлгідегі кәсіби жоғары білімі туралы диплом берілгенге дейін іске асырылады.', 9, 0, 'Normal', 12, 90, 207.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('6. Келісім-шарт шарттарына өзгеріс енгізу және келісім-шартқа толықтырулыр енгізу тәртібі
', 0, 0, 'Bold', 12, 90, 208.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('6.1 Осы келісім-шарт тараптардың келісімі бойынша өзгертілуі немесе толықтырылуы мүмкін. Осы келісім-шартқа енгізілген кез келген өзгертулер мен толықтырулар, жазбаша үлгіде жүргізілгенінде ғана жарамды болып есептеледі.
', 9, 0, 'Normal', 12, 90, 209.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('7. Даулы мәселелерді шешу тәртібі
', 0, 0, 'Bold', 12, 90, 210.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('7.1 Туындаған кез-келген даулы мәселелер тараптардың келісімі бойынша немесе сот арқылы шешіледі.
', 9, 0, 'Normal', 12, 90, 211.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('8. Форс мажорлық жағдайлар
', 0, 0, 'Bold', 12, 90, 212.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('8.1 Тараптардың осы келісім-шарт түзілген соң пайда болған, алдын ала білмеген немесе саналы іс-шаралармен алдын ала болдырмауға мүмкіндік болмаған, игерілуі мүмкін емес күштер  жағдайы салдарынан, төтенше сипаттағы  оқиғалар нәтижесінде осы келісім-шарт бойынша міндеттемелерді жекелей немесе толық орындамау жауапкершілігінен босатылады. Бұл жағдайда осы келісім-шарт мерзімі әлгіндей жағдайлар  мерзіміне сай өзгертіледі.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('9. Қорытынды ереже
', 0, 0, 'Bold', 12, 90, 215.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('9.1 Осы Келісім-шарт мемлекеттік тілде  құрылған және бірдей заң күшіне ие екі нұсқада түзілген.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('10. Жақтардың заңды мекен-жайы және банк реквизиттері
', 0, 0, 'Bold', 12, 90, 217.00, true);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('ОҚПУ,  Шымкент қ., 160019, Жангелдин к-сі, 13а. тел. 53-67-82.
...
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('БІЛІМ АЛУШЫНЫҢ пошталық мекен-жайы, реквизиттері:
$rekvizit, $email,  $phone.', 9, 0, 'Normal', 12, 90, 219.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('БІЛІМ БЕРУ ҰЙЫМЫ:
ОҚПУ президенті,
Юнусов М.Б.										      _________________________
	             (қолы)							     	`
', 9, 15, 'Normal', 12, 90, 221.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('БІЛІМ АЛУШЫ:
$fio
_________________________
	          (қолы)							     	`
', 306, -72, 'Normal', 12, 90, 222.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('Келісім-шарт талаптары мен Ішкі еңбек тәртібі ережелерімен таныстым
                                                                                _________________________________
                                                                                     ', 243, 21, 'Normal', 12, 90, 223.00, false);
INSERT INTO public.pdf_property (text, x, y, font, size, pdf_document_id, order_number, center) VALUES ('БІЛІМ АЛУШЫНЫҢ қолы                                                                             ', 417, -18, 'Normal', 8, 90, 224.00, false);
