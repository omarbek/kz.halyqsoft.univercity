...
CREATE SEQUENCE s_lost_and_found
MINVALUE 1
START WITH 1
NO CYCLE;

ALTER TABLE ONLY lost_and_found
  ADD CONSTRAINT pk_lost_and_found PRIMARY KEY (id);
ALTER TABLE ONLY lost_and_found
  ADD CONSTRAINT fk_lost_and_found_users FOREIGN KEY (finder_id)
REFERENCES users (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY lost_and_found
  ADD CONSTRAINT fk_lost_and_found_users_created FOREIGN KEY (created_by)
REFERENCES users (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
