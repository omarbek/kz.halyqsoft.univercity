...
public class V_CURRICULUM_ADD_PROGRAM extends AbstractEntity {
	...
	@FieldInfo(type = EFieldType.TEXT, max = 13, order = 5, columnWidth = 120)
	...
	@FieldInfo(type = EFieldType.TEXT, order = 9,inEdit = false,inGrid = false)
	@Column(name = "EDUCATION_MODULE_TYPE_NAME")
	private String educationModuleTypeName;
	
	@FieldInfo(type = EFieldType.TEXT, max = 64, order = 10, inEdit = false, inView = false, columnWidth = 120)
