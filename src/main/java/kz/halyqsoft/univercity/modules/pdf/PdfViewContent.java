 ...
 */
public class PdfViewContent extends VerticalLayout {
    ...
    public static boolean isForHRD =false;
    private TabSheet mainTS;
    private Component searchComponent;
    private TreeTable sideBarGenerateTT;

    public PdfViewContent(boolean isForHRD) {
        PdfViewContent.isForHRD = isForHRD;
        initView(true);
    }

    public void initView(boolean b) {
    ...
    public Component initAndGetCatalogTab(){
        ...
        {
            CommonUtils.LOG.error("Unable to run catalog tab container");
            e.printStackTrace();
        }
    ...
    public Component initAndGetSubstitutionTab(){
        ...
        {
            CommonUtils.LOG.error("Unable to run substitution tab container");
            e.printStackTrace();
        }
    ...
    public Component initAndGetSearchTab(){
        ...
        {
            CommonUtils.LOG.error("Unable to run search tab container");
            e.printStackTrace();
        }
                ...
                try {
                    if (valueChangeEvent != null && valueChangeEvent.getProperty() != null && valueChangeEvent.getProperty().getValue() != null) {
                        ...
                        if(valueChangeEvent.getProperty().getValue().toString().equals(FIRST_OPTION))
                        {
                            ...
                            PdfGenerationPart pdfGenerationPart = new PdfGenerationPart(file, getUILocaleUtil().getCaption("loading"), isForHRD);
