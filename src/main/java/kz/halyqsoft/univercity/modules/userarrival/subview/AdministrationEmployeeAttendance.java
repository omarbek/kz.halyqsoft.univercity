...
public class AdministrationEmployeeAttendance implements EntityListener {
    ...
    public AdministrationEmployeeAttendance(EmployeeAttendance employeeAttendance){
