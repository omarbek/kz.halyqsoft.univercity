...
import kz.halyqsoft.univercity.modules.changestudyyear.dialogs.ChooseStatusDialog;
...
public class ProblemStudentsView  implements FilterPanelListener {
    ...
    public void initView() throws Exception {
        ...
        Button changeStudyYearBtn = new Button(getUILocaleUtil().getCaption("change.status"));
        ...
        changeStudyYearBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent clickEvent) {
                if(studentGW.getSelectedEntities().size()>0){
                    try{
                        ChooseStatusDialog chooseStatusDialog = new ChooseStatusDialog(ProblemStudentsView.this);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }else{
    ...
    public ChangeToNextYearGroupFilterPanel getChangeToNextYearGroupFilterPanel() {
        return changeToNextYearGroupFilterPanel;
    }
    ...
    public void doFilter(AbstractFilterBean abstractFilterBean) {
        ...
        sb.insert(0, " where se.child_id isnull and vs.category_id = "+ STUDENT_CATEGORY.STUDENT_ID.getId()+" and vs.student_status_id not in ( "+ STUDENT_STATUS.STUDYING_ID.getId()+" ," +STUDENT_STATUS.DEDUCTED_ID + ", " + STUDENT_STATUS.GRADUATED_ID + " ) and vs.study_year_id NOTNULL and vs.groups_id NOTNULL ");
