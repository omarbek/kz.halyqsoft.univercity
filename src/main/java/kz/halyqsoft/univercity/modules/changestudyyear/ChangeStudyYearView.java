...
public class ChangeStudyYearView extends AbstractTaskView implements FilterPanelListener {

    private GridWidget studentGW;
    private ChangeToNextYearGroupFilterPanel changeToNextYearGroupFilterPanel;
    ...
    public void initView(boolean b) throws Exception {
        ...
        changeStudyYearBtn.setWidth(300,Unit.PIXELS);
