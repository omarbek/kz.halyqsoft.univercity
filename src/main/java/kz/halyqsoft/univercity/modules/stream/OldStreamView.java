...
public class OldStreamView extends AbstractTaskView implements EntityListener, FilterPanelListener {

    private GridWidget ssGW;
    private StreamFilterPanel streamFilterPanel;

    public OldStreamView(AbstractTask task) throws Exception {
        super(task);
    }
