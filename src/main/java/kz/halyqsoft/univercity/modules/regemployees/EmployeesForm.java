...
public class EmployeesForm /*extends AbstractFormWidgetView implements PhotoWidgetListener*/ {
    ...
    private TableWidget employeeDeptTW, documentsTW, languagesTW, medicalCheckupTW;
    private TableWidget awardsTW, socialCategoriesTW, publicationTW;
...
//
//        final FormModel fatherFM = createParentData("parents.data.father", FATHER);
//
//        final FormModel motherFM = createParentData("parents.data.mother", MOTHER);
//
...
//    }
//
//    private FormModel createParentData(String caption, int parent_number) throws Exception {
...
//                savePass = false;
//                saveUNT = false;
//                employeeDeptTW = new TableWidget(VT_EMPLOYEE_DEPT.class);
//                employeeDeptTW.addEntityListener(EmployeesForm.this);
//                employeeDeptTW.setWidth("667px");
//                DBTableModel employeeDeptTM = (DBTableModel) employeeDeptTW.getWidgetModel();
//                employeeDeptTM.setPageLength(5);
//                QueryModel entrantSpecialityQM = ((DBTableModel) employeeDeptTW.getWidgetModel()).getQueryModel();
//                ID employeeId = ID.valueOf(-1);
//                if (!dataFM.isCreateNew()) {
//                    try {
//                        employeeId = dataFM.getEntity().getId();
//                    } catch (Exception ex) {
//                        ex.printStackTrace();//TODO catch
//                    }
//                }
//                entrantSpecialityQM.addWhere("employee", ECriteria.EQUAL, employeeId);
//
...
//            @Override
//            public void buttonClick(Button.ClickEvent event) {
//                employeeDeptTW = new TableWidget(V_ENTRANT_SPECIALITY.class);
//                employeeDeptTW.addEntityListener(EmployeesForm.this);
//                employeeDeptTW.setWidth("667px");
//                DBTableModel entrantSpecialityTM = (DBTableModel) employeeDeptTW.getWidgetModel();
//                entrantSpecialityTM.setPageLength(5);
//                QueryModel employeeDeptQM = ((DBTableModel) employeeDeptTW.getWidgetModel()).getQueryModel();
//                ID employeeId = ID.valueOf(-1);
//                if (!dataFM.isCreateNew()) {
//                    try {
//                        employeeId = dataFM.getEntity().getId();
...
//                    }
//                }
//                employeeDeptQM.addWhere("employee", ECriteria.EQUAL, employeeId);
//
//                flagSave(flag, dataFM, userPassportFM, militaryDocFM, disabilityDocFM, repatriateDocFM, preemptiveRightFM, educationFM, untCertificateFM,
//                        grantDocFM, addressFactFM, addressRegFM, motherFM, fatherFM, dataContractFM);
//
...
//                registrationHSP.removeComponent(contentHL);
//                contentHL = new HorizontalLayout();
//                contentHL.addComponent(employeeDeptTW);
...
//                languagesTW.addEntityListener(EmployeesForm.this);
...
//                medicalCheckupTW.addEntityListener(EmployeesForm.this);
...
//                publicationTW.addEntityListener(EmployeesForm.this);
//                publicationTW.setWidth("667px");
//                DBTableModel untRatesTM = (DBTableModel) publicationTW.getWidgetModel();
...
//                dataUNT.addComponent(publicationTW);
//
//                contentHL.removeAllComponents();
...
//                awardsTW.addEntityListener(EmployeesForm.this);
...
//                socialCategoriesTW.addEntityListener(EmployeesForm.this);
...
//                break;
//            case SPECIALITY:
//                if (employeeDeptTW.getEntityCount() > 0) {
//                    saveSpec = true;
//                }
//                break;
//            case ID_DOC:
...
//                break;
//            case Unt:
//                if (publicationTW.getEntityCount() > 1) {
//                    saveUNT = true;
//                }
//                break;
//            case GRANT_DOC:
...
//    }
//
//    private boolean preSaveCertificate(Entity e, boolean isNew) {
//        if (dataAFW.getWidgetModel().isCreateNew()) {
//            Message.showInfo(getUILocaleUtil().getMessage("info.save.base.data.first"));
//            return false;
//        }
...
//                saveUNT = true;
//                QueryModel untRatesQM = ((DBTableModel) publicationTW.getWidgetModel()).getQueryModel();
...
//            return true;
//        } else if (source.equals(employeeDeptTW)) {
//            FormModel entrantSpecialityFM = ((DBTableModel) employeeDeptTW.getWidgetModel()).getFormModel();
...
//            }
//
//            int count = employeeDeptTW.getEntityCount();
//            if (count == 4) {
...
//
//    @Override
//    public boolean preSaveCertificate(Object source, Entity e, boolean isNew, int buttonId) throws Exception {
...
//            return preSaveCertificate(e, isNew);
...
//        }
//        return super.preSaveCertificate(source, e, isNew, buttonId);
//    }
//
//    @Override
